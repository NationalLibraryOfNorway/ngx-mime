...
export class ManifestService {
  static readonly manifests: ManifestMenuItem[] = [
    ...
    {
      label: 'Multiple Viewers',
      uri: [
        'assets/fixtures/presentation/2/attribution-manifest.json',
        'assets/fixtures/presentation/2/searchable-manifest.json',
      ],
      iiifVersion: '2',
    },
    {
    ...
    },
    {
      label: 'Multiple Viewers',
      uri: [
        'assets/fixtures/presentation/3/attribution-manifest.json',
        'assets/fixtures/presentation/3/searchable-manifest.json',
      ],
      iiifVersion: '3',
    },
  ];
  ...
  getManifests(iiifVersion: string = '3'): ManifestMenuItem[] {
