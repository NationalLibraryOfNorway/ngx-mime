...
import * as i1 from "./content-search-dialog.component";
import * as i2 from "../shared/shared.module";
export declare class ContentSearchDialogModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<ContentSearchDialogModule, never>;
