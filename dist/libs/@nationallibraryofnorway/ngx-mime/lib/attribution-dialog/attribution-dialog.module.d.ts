...
import * as i1 from "./attribution-dialog.component";
import * as i2 from "../shared/shared.module";
export declare class AttributionDialogModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<AttributionDialogModule, never>;
