...
import * as i1 from "./canvas-group-dialog.component";
import * as i2 from "../shared/shared.module";
export declare class CanvasGroupDialogModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<CanvasGroupDialogModule, never>;
