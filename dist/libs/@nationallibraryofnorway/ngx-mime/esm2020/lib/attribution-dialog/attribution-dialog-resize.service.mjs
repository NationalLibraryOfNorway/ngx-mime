...
AttributionDialogResizeService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: AttributionDialogResizeService, deps: [{ token: i1.MimeDomHelper }], target: i0.ɵɵFactoryTarget.Injectable });
