...
AttributionDialogResizeService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.4", ngImport: i0, type: AttributionDialogResizeService, deps: [{ token: i1.MimeDomHelper }], target: i0.ɵɵFactoryTarget.Injectable });
