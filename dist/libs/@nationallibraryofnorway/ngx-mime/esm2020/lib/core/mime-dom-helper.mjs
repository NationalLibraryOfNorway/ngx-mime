...
MimeDomHelper.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.4", ngImport: i0, type: MimeDomHelper, deps: [{ token: i1.FullscreenService }], target: i0.ɵɵFactoryTarget.Injectable });
