...
class OsdToolbarComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.1", ngImport: i0, type: OsdToolbarComponent, deps: [{ token: MimeViewerIntl }, { token: i0.Renderer2 }, { token: i1.BreakpointObserver }, { token: i0.ChangeDetectorRef }, { token: MimeResizeService }, { token: ViewerService }, { token: CanvasService }, { token: StyleService }, { token: IiifManifestService }], target: i0.ɵɵFactoryTarget.Component }); }
