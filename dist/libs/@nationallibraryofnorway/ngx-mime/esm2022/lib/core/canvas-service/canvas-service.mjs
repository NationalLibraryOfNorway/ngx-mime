...
export class CanvasService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.9", ngImport: i0, type: CanvasService, deps: [{ token: i1.ViewerLayoutService }], target: i0.ɵɵFactoryTarget.Injectable }); }
