...
export class MimeResizeService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: MimeResizeService, deps: [{ token: i1.ViewerService }], target: i0.ɵɵFactoryTarget.Injectable }); }
