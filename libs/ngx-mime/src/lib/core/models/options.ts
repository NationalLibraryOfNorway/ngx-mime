...
export class Options {
  ...
  defaultZoomLevel = 0;
  opacity = 1;
  compositeOperation: string | null = null;
  placeholderFillStyle: string | CanvasGradient | CanvasPattern | null = null;
  degrees = 0;
  minZoomLevel = this.defaultZoomLevel;
  maxZoomLevel: number | null = null;
  ...
  zoomPerSecond = 1.0;
  showNavigator = false;
  navigatorId: string | null = null;
  navigatorPosition = 'TOP_RIGHT';
  navigatorSizeRatio = 0.2;
  navigatorMaintainSizeRatio = false;
  navigatorTop: number | string | null = null;
  navigatorLeft: number | string | null = null;
  navigatorHeight: number | string | null = null;
  navigatorWidth: number | string | null = null;
  ...
  zoomInButton: string |null = null;
  zoomOutButton: string | null = null;
  homeButton: string | null = null;
  fullPageButton: string | null = null;
  rotateLeftButton: string | null = null;
  rotateRightButton: string | null = null;
  ...
  referenceStripElement: Element | null = null;
  referenceStripHeight: number | null = null;
  referenceStripWidth: number | null = null;
