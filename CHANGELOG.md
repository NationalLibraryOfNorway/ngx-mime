...
- ⚠️  require Angular 21 and migrate ngx-mime to zoneless ([#521](https://github.com/NationalLibraryOfNorway/ngx-mime/pull/521))

### ⚠️  Breaking Changes

- require Angular 21 and migrate ngx-mime to zoneless  ([#521](https://github.com/NationalLibraryOfNorway/ngx-mime/pull/521))
  This release requires Angular 21."
  M	apps/demo/project.json
  M	apps/demo/src/app/app.component.html
  M	apps/demo/src/app/app.component.ts
  M	apps/demo/src/app/core/auth.interceptor.ts
  M	apps/demo/src/app/core/navbar/navbar.component.html
  A	apps/demo/src/app/core/navbar/navbar.component.spec.ts
  M	apps/demo/src/app/core/navbar/navbar.component.ts
  M	apps/demo/src/app/core/navbar/theme-picker/style-manager/style-manager.service.ts
  M	apps/demo/src/app/core/navbar/theme-picker/theme-picker.component.html
  M	apps/demo/src/app/core/navbar/theme-picker/theme-picker.component.ts
  M	apps/demo/src/app/core/navbar/theme-picker/theme-service/theme.service.ts
  M	apps/demo/src/app/core/sidenav/sidenav.component.html
  A	apps/demo/src/app/core/sidenav/sidenav.component.spec.ts
  M	apps/demo/src/app/core/sidenav/sidenav.component.ts
  M	apps/demo/src/app/viewer/viewer.component.html
  M	apps/demo/src/app/viewer/viewer.component.ts
  M	apps/demo/src/environments/environment.ts
  M	apps/demo/src/test-setup.ts
  M	apps/demo/tsconfig.json
  M	apps/demo/tsconfig.spec.json
  M	apps/elements/project.json
  M	apps/elements/src/app/app.component.html
  M	apps/elements/src/app/app.component.spec.ts
  M	apps/elements/src/app/app.component.ts
  M	apps/elements/src/environments/environment.ts
  M	apps/elements/src/main.ts
  M	apps/elements/src/test-setup.ts
  M	apps/elements/tsconfig.json
  M	apps/elements/tsconfig.spec.json
  A	apps/elements/webpack.config.js
  M	apps/integration-e2e/src/helpers/animations.ts
  M	apps/integration-e2e/src/pages/content-search.po.ts
  M	apps/integration-e2e/src/pages/viewer.po.ts
  M	apps/integration-e2e/src/step-definitions/access-keys.steps.ts
  M	apps/integration-e2e/src/step-definitions/browse.steps.ts
  M	apps/integration-e2e/src/step-definitions/content-search.steps.ts
  M	apps/integration-e2e/src/step-definitions/fullscreen.steps.ts
  M	apps/integration-e2e/src/step-definitions/information-dialog.steps.ts
  M	apps/integration-e2e/src/step-definitions/layout.steps.ts
  M	apps/integration-e2e/src/step-definitions/recognized-text-content.steps.ts
  M	apps/integration-e2e/src/step-definitions/view-switch.steps.ts
  M	apps/integration-e2e/src/step-definitions/zoom.steps.ts
  M	apps/integration-e2e/src/support/fixtures.ts
  M	apps/integration/project.json
  M	apps/integration/src/app/app.component.spec.ts
  M	apps/integration/src/app/viewer/components/viewer/viewer.component.html
  M	apps/integration/src/app/viewer/components/viewer/viewer.component.spec.ts
  M	apps/integration/src/app/viewer/components/viewer/viewer.component.ts
  M	apps/integration/src/app/viewer/elements/viewer/viewer.component.html
  M	apps/integration/src/app/viewer/elements/viewer/viewer.component.spec.ts
  M	apps/integration/src/app/viewer/elements/viewer/viewer.component.ts
  M	apps/integration/src/app/viewer/viewer.component.html
  M	apps/integration/src/app/viewer/viewer.component.spec.ts
  M	apps/integration/src/app/viewer/viewer.component.ts
  M	apps/integration/src/environments/environment.ts
  M	apps/integration/src/index-elements.html
  M	apps/integration/src/test-setup.ts
  M	apps/integration/tsconfig.json
  M	apps/integration/tsconfig.spec.json
  M	eslint.config.mjs
  M	libs/ngx-mime/README.md
  M	libs/ngx-mime/package.json
  D	libs/ngx-mime/src/lib/attribution-dialog/attribution-dialog-resize.service.spec.ts
  D	libs/ngx-mime/src/lib/attribution-dialog/attribution-dialog-resize.service.ts
  M	libs/ngx-mime/src/lib/attribution-dialog/attribution-dialog.component.html
  M	libs/ngx-mime/src/lib/attribution-dialog/attribution-dialog.component.spec.ts
  M	libs/ngx-mime/src/lib/attribution-dialog/attribution-dialog.component.ts
  M	libs/ngx-mime/src/lib/attribution-dialog/attribution-dialog.service.spec.ts
  M	libs/ngx-mime/src/lib/attribution-dialog/attribution-dialog.service.ts
  M	libs/ngx-mime/src/lib/canvas-group-dialog/canvas-group-dialog.component.html
  M	libs/ngx-mime/src/lib/canvas-group-dialog/canvas-group-dialog.component.spec.ts
  M	libs/ngx-mime/src/lib/canvas-group-dialog/canvas-group-dialog.component.ts
  M	libs/ngx-mime/src/lib/content-search-dialog/content-search-dialog-config-strategy-factory.ts
  M	libs/ngx-mime/src/lib/content-search-dialog/content-search-dialog-config-strategy.ts
  M	libs/ngx-mime/src/lib/content-search-dialog/content-search-dialog.component.html
  M	libs/ngx-mime/src/lib/content-search-dialog/content-search-dialog.component.spec.ts
  M	libs/ngx-mime/src/lib/content-search-dialog/content-search-dialog.component.ts
  M	libs/ngx-mime/src/lib/content-search-dialog/content-search-dialog.service.ts
  M	libs/ngx-mime/src/lib/core/access-keys-handler-service/access-keys.service.spec.ts
  M	libs/ngx-mime/src/lib/core/access-keys-handler-service/access-keys.service.ts
  M	libs/ngx-mime/src/lib/core/alto-service/alto.service.spec.ts
  M	libs/ngx-mime/src/lib/core/alto-service/alto.service.ts
  M	libs/ngx-mime/src/lib/core/builders/alto/alto.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/alto/layout.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/alto/page.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/alto/print-space.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/alto/strings.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/alto/styles.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/alto/text-blocks.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/alto/text-lines.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/search-result.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v2/builder-utils.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v2/canvas.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v2/images.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v2/metadata.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v2/resource.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v2/sequence.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v2/sizes.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v2/structure.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v2/tile-source.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v2/tiles.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v3/builder-utils.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v3/canvas.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v3/images.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v3/metadata.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v3/resource.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v3/service.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v3/sizes.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v3/structure.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v3/tile-source.builder.ts
  M	libs/ngx-mime/src/lib/core/builders/iiif/v3/tiles.builder.ts
  M	libs/ngx-mime/src/lib/core/canvas-group-position/calculate-canvas-group-position-utils.ts
  M	libs/ngx-mime/src/lib/core/canvas-group-position/one-page-calculate-page-position-strategy.ts
  M	libs/ngx-mime/src/lib/core/canvas-service/canvas-service.spec.ts
  M	libs/ngx-mime/src/lib/core/canvas-service/canvas-service.ts
  M	libs/ngx-mime/src/lib/core/canvas-service/one-canvas-per-canvas-group-strategy.ts
  M	libs/ngx-mime/src/lib/core/canvas-service/two-canvas-per-canvas-group-strategy.ts
  M	libs/ngx-mime/src/lib/core/click-service/click.service.spec.ts
  M	libs/ngx-mime/src/lib/core/ext/svg-overlay.ts
  M	libs/ngx-mime/src/lib/core/fullscreen-service/fullscreen.service.spec.ts
  M	libs/ngx-mime/src/lib/core/fullscreen-service/fullscreen.service.ts
  M	libs/ngx-mime/src/lib/core/highlight-service/highlight.service.spec.ts
  ...
  M	libs/ngx-mime/src/lib/core/iiif-manifest-service/iiif-manifest-utils.ts
  A	libs/ngx-mime/src/lib/core/intl/viewer-intl.provider.spec.ts
  M	libs/ngx-mime/src/lib/core/intl/viewer-intl.provider.ts
  M	libs/ngx-mime/src/lib/core/intl/viewer-intl.ts
  M	libs/ngx-mime/src/lib/core/mime-dom-helper.ts
  M	libs/ngx-mime/src/lib/core/mime-resize-service/mime-resize.service.spec.ts
  M	libs/ngx-mime/src/lib/core/mime-resize-service/mime-resize.service.ts
  A	libs/ngx-mime/src/lib/core/mime-viewer-config.spec.ts
  M	libs/ngx-mime/src/lib/core/mime-viewer-config.ts
  M	libs/ngx-mime/src/lib/core/mode-service/mode.service.spec.ts
  M	libs/ngx-mime/src/lib/core/mode-service/mode.service.ts
  M	libs/ngx-mime/src/lib/core/models/canvas-groups.ts
  M	libs/ngx-mime/src/lib/core/models/index.ts
  M	libs/ngx-mime/src/lib/core/models/recognized-text-mode.ts
  M	libs/ngx-mime/src/lib/core/navigation/content-search-navigation-service/content-search-navigation.service.spec.ts
  M	libs/ngx-mime/src/lib/core/navigation/content-search-navigation-service/content-search-navigation.service.ts
  M	libs/ngx-mime/src/lib/core/spinner-service/spinner.service.ts
  M	libs/ngx-mime/src/lib/core/style-service/style.service.spec.ts
  M	libs/ngx-mime/src/lib/core/style-service/style.service.ts
  M	libs/ngx-mime/src/lib/core/utils.ts
  M	libs/ngx-mime/src/lib/core/viewer-layout-service/viewer-layout-service.spec.ts
  M	libs/ngx-mime/src/lib/core/viewer-layout-service/viewer-layout-service.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/canvas-group-mask.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/dashboard-mode-calculate-next-canvas-group-strategy.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/go-to-canvas-group-strategy.spec.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/go-to-canvas-group-strategy.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/iiif-tile-source-strategy.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/navigator-calculate-next-canvas-group-strategy.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/page-mode-calculate-next-canvas-group-strategy.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/page-zoomed-mode-calculate-next-canvas-group-strategy.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/swipe-utils.spec.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/viewer.service.spec.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/viewer.service.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/zoom-strategy.ts
  M	libs/ngx-mime/src/lib/core/viewer-service/zoom-utils.ts
  M	libs/ngx-mime/src/lib/help-dialog/help-dialog-config-strategy-factory.ts
  M	libs/ngx-mime/src/lib/help-dialog/help-dialog-config-strategy.ts
  M	libs/ngx-mime/src/lib/help-dialog/help-dialog.component.html
  M	libs/ngx-mime/src/lib/help-dialog/help-dialog.component.spec.ts
  M	libs/ngx-mime/src/lib/help-dialog/help-dialog.component.ts
  M	libs/ngx-mime/src/lib/help-dialog/help-dialog.service.spec.ts
  M	libs/ngx-mime/src/lib/help-dialog/help-dialog.service.ts
  M	libs/ngx-mime/src/lib/information-dialog/information-dialog-config-strategy-factory.ts
  M	libs/ngx-mime/src/lib/information-dialog/information-dialog-config-strategy.ts
  M	libs/ngx-mime/src/lib/information-dialog/information-dialog.component.html
  M	libs/ngx-mime/src/lib/information-dialog/information-dialog.component.spec.ts
  M	libs/ngx-mime/src/lib/information-dialog/information-dialog.component.ts
  M	libs/ngx-mime/src/lib/information-dialog/information-dialog.service.spec.ts
  M	libs/ngx-mime/src/lib/information-dialog/information-dialog.service.ts
  M	libs/ngx-mime/src/lib/information-dialog/metadata/metadata.component.html
  M	libs/ngx-mime/src/lib/information-dialog/metadata/metadata.component.spec.ts
  M	libs/ngx-mime/src/lib/information-dialog/metadata/metadata.component.ts
  M	libs/ngx-mime/src/lib/information-dialog/table-of-contents/table-of-contents.component.html
  M	libs/ngx-mime/src/lib/information-dialog/table-of-contents/table-of-contents.component.spec.ts
  M	libs/ngx-mime/src/lib/information-dialog/table-of-contents/table-of-contents.component.ts
  M	libs/ngx-mime/src/lib/ngx-mime.module.spec.ts
  M	libs/ngx-mime/src/lib/ngx-mime.module.ts
  M	libs/ngx-mime/src/lib/test/alto-service-stub.ts
  M	libs/ngx-mime/src/lib/test/canvas-service-stub.ts
  A	libs/ngx-mime/src/lib/test/content-search-navigation-service-stub.ts
  M	libs/ngx-mime/src/lib/test/fullscreen-service-stub.ts
  M	libs/ngx-mime/src/lib/test/iiif-content-search-service-stub.ts
  M	libs/ngx-mime/src/lib/test/iiif-manifest-service-stub.ts
  D	libs/ngx-mime/src/lib/test/media-stub.ts
  M	libs/ngx-mime/src/lib/test/mime-resize-service-stub.ts
  M	libs/ngx-mime/src/lib/test/mock-breakpoint-observer.ts
  A	libs/ngx-mime/src/lib/test/viewer-layout-service-stub.ts
  M	libs/ngx-mime/src/lib/test/viewer-service-stub.ts
  M	libs/ngx-mime/src/lib/view-dialog/icon/icon.component.html
  M	libs/ngx-mime/src/lib/view-dialog/icon/icon.component.spec.ts
  M	libs/ngx-mime/src/lib/view-dialog/icon/icon.component.ts
  M	libs/ngx-mime/src/lib/view-dialog/view-dialog-config-strategy-factory.ts
  M	libs/ngx-mime/src/lib/view-dialog/view-dialog-config-strategy.ts
  M	libs/ngx-mime/src/lib/view-dialog/view-dialog.component.html
  M	libs/ngx-mime/src/lib/view-dialog/view-dialog.component.spec.ts
  M	libs/ngx-mime/src/lib/view-dialog/view-dialog.component.ts
  M	libs/ngx-mime/src/lib/view-dialog/view-dialog.service.ts
  M	libs/ngx-mime/src/lib/viewer/osd-toolbar/osd-toolbar.component.html
  M	libs/ngx-mime/src/lib/viewer/osd-toolbar/osd-toolbar.component.spec.ts
  M	libs/ngx-mime/src/lib/viewer/osd-toolbar/osd-toolbar.component.ts
  M	libs/ngx-mime/src/lib/viewer/recognized-text-content/recognized-text-content.component.html
  ...
  A	libs/ngx-mime/src/lib/viewer/recognized-text-content/recognized-text-content.model.ts
  M	libs/ngx-mime/src/lib/viewer/test-host.component.ts
  M	libs/ngx-mime/src/lib/viewer/viewer-footer/canvas-group-navigator/canvas-group-navigator.component.html
  M	libs/ngx-mime/src/lib/viewer/viewer-footer/canvas-group-navigator/canvas-group-navigator.component.spec.ts
  M	libs/ngx-mime/src/lib/viewer/viewer-footer/canvas-group-navigator/canvas-group-navigator.component.ts
  M	libs/ngx-mime/src/lib/viewer/viewer-footer/content-search-navigator/content-search-navigator.component.html
  M	libs/ngx-mime/src/lib/viewer/viewer-footer/content-search-navigator/content-search-navigator.component.spec.ts
  M	libs/ngx-mime/src/lib/viewer/viewer-footer/content-search-navigator/content-search-navigator.component.ts
  M	libs/ngx-mime/src/lib/viewer/viewer-footer/viewer-footer.component.html
  M	libs/ngx-mime/src/lib/viewer/viewer-footer/viewer-footer.component.spec.ts
  M	libs/ngx-mime/src/lib/viewer/viewer-footer/viewer-footer.component.ts
  M	libs/ngx-mime/src/lib/viewer/viewer-header/viewer-header.component.html
  M	libs/ngx-mime/src/lib/viewer/viewer-header/viewer-header.component.spec.ts
  M	libs/ngx-mime/src/lib/viewer/viewer-header/viewer-header.component.ts
  M	libs/ngx-mime/src/lib/viewer/viewer-spinner/viewer-spinner.component.html
  M	libs/ngx-mime/src/lib/viewer/viewer-spinner/viewer-spinner.component.spec.ts
  M	libs/ngx-mime/src/lib/viewer/viewer-spinner/viewer-spinner.component.ts
  M	libs/ngx-mime/src/lib/viewer/viewer.component.html
  M	libs/ngx-mime/src/lib/viewer/viewer.component.spec.ts
  M	libs/ngx-mime/src/lib/viewer/viewer.component.ts
  M	libs/ngx-mime/src/lib/viewer/viewer.providers.ts
  M	libs/ngx-mime/src/test-setup.ts
  M	libs/ngx-mime/tsconfig.json
  M	libs/ngx-mime/tsconfig.spec.json
  D	migrations.json
  M	package.json
...
- **accessibility:** expose recognized text to screen readers ([#516](https://github.com/NationalLibraryOfNorway/ngx-mime/pull/516), [#515](https://github.com/NationalLibraryOfNorway/ngx-mime/issues/515))
