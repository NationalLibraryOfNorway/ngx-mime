...
describe('ContentSearchNavigationService', () => {
  ...
  beforeEach(
    inject([ContentSearchNavigationService, HttpTestingController, IiifContentSearchService, PageService],
      fakeAsync((csns: ContentSearchNavigationService, httpMock: HttpTestingController,
                    icss: IiifContentSearchService, pageService: PageService) => {
  ...
  it('should create', inject([ContentSearchNavigationService], (service: ContentSearchNavigationService) => {
    expect(service).toBeTruthy();
  }));

  it('should go to next index',
    inject([ContentSearchNavigationService], fakeAsync((csns: ContentSearchNavigationService) => {
      csns.update(5);
  ...
  it('should return 2 if canvasIndex is between second and fourth hit',
    inject([ContentSearchNavigationService], fakeAsync((csns: ContentSearchNavigationService) => {
      csns.update(6);
      expect(csns.getCurrentIndex()).toBe(2);
  })));
