...
describe('IiifManifestService', () => {
  ...
  it(
    'should be created',
    inject([IiifManifestService], (svc: IiifManifestService) => {
  ...
  it(
    ...
    inject(
      ...
      fakeAsync((svc: IiifManifestService, http: HttpClient, httpMock: HttpTestingController) => {
        ...
        svc.load('dummyUrl');
        svc.currentManifest.subscribe((manifest: Manifest) => (result = manifest));
  ...
  it(
    'should return error message if manifest url is missing',
    inject(
      [IiifManifestService, HttpClient, HttpTestingController],
      fakeAsync((svc: IiifManifestService, http: HttpClient, httpMock: HttpTestingController) => {
        let result: Manifest = null;
  ...
  it(
    'should return error message if IiifManifestService could not load manifest',
    inject(
      [IiifManifestService, HttpClient, HttpTestingController],
      fakeAsync((svc: IiifManifestService, http: HttpClient, httpMock: HttpTestingController) => {
        let result: Manifest = null;
  ...
  it(
    'should return error message when manifest is not valid',
    inject(
      [IiifManifestService, HttpClient, HttpTestingController],
      fakeAsync((svc: IiifManifestService, http: HttpClient, httpMock: HttpTestingController) => {
        let result: Manifest = null;
