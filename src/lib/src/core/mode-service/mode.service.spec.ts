...
describe('ModeService', () => {
  ...
  it(
    'should be created',
    inject([ModeService], (service: ModeService) => {
      expect(service).toBeTruthy();
    })
  );

  it(
    'should emit when mode changes',
    inject([ModeService], (service: ModeService) => {
  ...
  it(
    'should not modify initial mode on mode change',
    inject([ModeService], (service: ModeService) => {
      service.initialMode = ViewerMode.DASHBOARD;
  ...
  it(
    'should change mode when toggled',
    inject([ModeService], (service: ModeService) => {
      service.initialMode = ViewerMode.DASHBOARD;
      service.toggleMode();
      expect(service.mode).toEqual(ViewerMode.PAGE);
  ...
  it(
    'should change mode to DASHBOARD when toggled in PAGE_ZOOMED',
    inject([ModeService], (service: ModeService) => {
  ...
  it(
    'should emit when mode is toggled',
    inject([ModeService], (service: ModeService) => {
      let selectedMode: ViewerMode;
      service.onChange.subscribe((mode: ModeChanges) => (selectedMode = mode.currentValue));
      service.initialMode = ViewerMode.DASHBOARD;
