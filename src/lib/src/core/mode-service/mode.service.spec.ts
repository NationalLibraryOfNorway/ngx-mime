...
describe('ModeService', () => {
  ...
  it('should not modify initial mode on mode change', inject([ModeService], (service: ModeService) => {
    service.initialMode = ViewerMode.DASHBOARD;
  ...
  it('should change mode when toggled', inject([ModeService], (service: ModeService) => {
    service.initialMode = ViewerMode.DASHBOARD;
    service.toggleMode();
    expect(service.mode).toEqual(ViewerMode.PAGE);
    service.toggleMode();
  ...
  it('should change mode to DASHBOARD when toggled in PAGE_ZOOMED', inject([ModeService], (service: ModeService) => {
