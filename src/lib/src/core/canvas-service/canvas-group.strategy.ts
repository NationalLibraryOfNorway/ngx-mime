...
export class OneCanvasPerCanvasGroupStrategy implements AbstractCanvasGroupStrategy {
...
export class TwoCanvasPerCanvasGroupStrategy implements AbstractCanvasGroupStrategy {
  addAll = (canvasRects: Rect[]) => {
    const canvasGroups = new CanvasGroups();
    // Single first page
